...
<p>Процент Вы получаете от прибыли сервиса с каждого Вашего обмена.
Пожалуйста, примите во внимание и понимание. Процент вознаграждения рассчитывается от прибыли сервиса по каждому доступному направлению
обмена, по некоторым направлениям обмена комиссия сервиса может быть 0%, может быть меньше 0% (то есть комиссия отсутствует) или сервис не
получает выгоду от обмена, значит сервис с этого обмена не имеет прибыли, в этих ситуациях вознаграждение не начисляется.</p>
